    ...
    return (
        <>
            <div className="mx-auto lg:px-2">
                <div className="flex justify-between items-center mb-1 gap-1 lg:px-3">
                    <div className="flex items-center bg-white w-full pl-4 sm:py-1 border border-gray-300 rounded-4 focus:outline-none focus:ring-2 focus:ring-violet-500">
                        ...
                        <VisibilityCheck user={user} check="student" checkType="role">
                            <Button
                                className="flex items-center gap-3 px-3 h-6 bg-transparent !text-gray-600 border-l border-gray-300 rounded-0 font-semibold hover:scale-105 transition-all duration-200"
                        ...
                        <VisibilityCheck user={user} check="course.create" checkType="permission">
                            <Button
                                className="flex items-center gap-3 h-6 bg-transparent !text-gray-600 border-l border-gray-200 rounded-0 font-semibold hover:scale-105 transition-all duration-200"
                                                ...
                                                {hasRole(user, "student") ? (
                                                    enrolledCourses.includes(course.id) ? (
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex-1 text-center text-violet-500 font-medium bg-violet-50 rounded-lg border border-violet-500 shadow-md px-3 lg:py-2 hover:bg-violet-300 transition-all duration-200"
                                                        >
                                                            Buy Now
                                                        </button>
